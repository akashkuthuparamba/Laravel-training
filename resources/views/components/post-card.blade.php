...
<article
    ...
    <div class="py-6 px-5 h-full flex flex-col">
        <div>
            {{-- TODO --}}
            <img src="{{asset('storage/'. $post->thumbnail)}}" alt="Blog Post illustration" class="rounded-xl" height=80% width=80%>
        </div>
        ...
        <div class="mt-6 flex flex-col justify-between flex-1">
            ...
            <div class="text-sm mt-4 space-y-4 q">
                <p>
                    {!! $post->excerpt !!}
                </p>
            </div>
            ...
            <footer class="flex justify-between items-center mt-8">
                <div class="flex items-center text-sm">
                    ...
                    <div class="ml-3">
                        <h5 class="font-bold">
                        <a href="/authers/{{ $post->auther->username }}">
                            {{ $post-> auther->name }}
                        </a>
                        </h5>
